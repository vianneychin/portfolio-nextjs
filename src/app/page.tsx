      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            hi Full Stack Software Engineer, coffee addict, gym rat, and gamer.
          </h1>
          ...
          <div className="mt-6 flex gap-6">
            <SocialLink
              href="https://github.com/vianneychin/"
        ...
        <p className="mt-16 text-base text-zinc-600 dark:text-zinc-400">
          <span className="mr-2">🐈</span>
          {` Enjoy some photos of my adorable cat Pepper being a menace while you're here.`}
        </p>
      </Container>
      <Photos />
